...
import node from '../assets/certificaciones/frontEnd/node-coderhouse.png';
...
export const certificacionesList = [
    {
        id: 1,
        description: "Realización de api backend con node.js, vistas con handlebars, socket.io, jwt, etc",
        link: "https://www.coderhouse.com/ar/certificados/66917afe86105585aedfa4f1?lang=es",
        image: node,
        icon: <FaLink />
    },
    {
        id: 2,
        description: "Aprendizaje práctico de React.js, con la realización de un ecommerce",
